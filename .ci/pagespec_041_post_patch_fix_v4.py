...
if len(sys.argv) != 2:
    raise SystemExit("usage: pagespec_041_post_patch_fix_v4.py PLUGIN_ROOT")
...
method_body = '''    def test_catalog_child_scripts_are_all_nonced(self):
        ...
        self.assertGreater(len(audit.nonces),0)
        self.assertTrue(all(value=='test-catalog-nonce' for value in audit.nonces),audit.nonces)
...
print("catalog executable-script nonce audit v4 applied")
